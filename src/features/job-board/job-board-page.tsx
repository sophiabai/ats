...
export function JobBoardPage() {
  ...
  if (isLoading) return <JobBoardSkeleton />;
  ...
  function navigateToPost(job: Requisition) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {filtered.map((job) => (
          <JobCard key={job.id} job={job} onClick={() => navigateToPost(job)} />
        ))}
        {filtered.length === 0 && (
...
export { JobBoardPage as Component };
